...
Helpful tips:
The pose model (pose_landmarker.task) downloads automatically on first run (~20MB)
Works best with footage where the disc is clearly visible against the background
